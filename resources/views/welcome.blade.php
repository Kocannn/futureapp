...
<head>
    ...
    <title>Tryout Online | FUTUREAPT</title>
...
<body class="bg-gradient-to-b from-slate-50 to-white text-gray-800">
    ...
    <header class="bg-white shadow-md sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            <h1 class="text-3xl font-extrabold text-indigo-700 tracking-wide">FUTUREAPT Tryout</h1>
            <nav class="space-x-6">
    ...
    <main class="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center">
        <div>
            <h2 class="text-5xl font-extrabold text-slate-900 mb-6 leading-tight">
                Siapkan Dirimu untuk <span class="text-indigo-600">Masa Depan Cerah</span>
            </h2>
            <p class="text-lg text-slate-700 mb-8 max-w-xl">
                Platform tryout online modern yang membantu kamu menguasai materi, mengevaluasi kemampuan, dan sukses dalam ujian. Mulai latihan sekarang dan raih hasil terbaikmu!
            </p>
            <div class="flex flex-wrap gap-5">
                <a href="/login" class="btn-primary bg-indigo-600 text-white px-8 py-3 rounded-xl font-semibold shadow-md transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
                    Masuk Sekarang
                </a>
                <a href="/register" class="btn-secondary border border-indigo-600 text-indigo-600 px-8 py-3 rounded-xl font-semibold transition-colors duration-300 hover:bg-indigo-50">
                    Daftar Gratis
                </a>
            </div>

            <div class="mt-12 grid grid-cols-3 gap-8 max-w-md text-center">
                <div>
        ...
        <div class="flex justify-center md:justify-end">
            <img src="URL_gambar_baru_anda.jpg" alt="Ilustrasi Tryout Online" class="max-w-full rounded-xl shadow-lg" />
        </div>
    </main>
        ...
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <div class="grid md:grid-cols-2 gap-10">
                <blockquote class="bg-white rounded-lg p-6 shadow-md text-slate-800">
                    <p class="mb-4 italic">"Tryout FUTUREAPT membantu saya fokus pada materi yang penting dan meningkatkan confidence saya sebelum ujian nasional. Sangat direkomendasikan!"</p>
...
<section class="bg-white py-20">
    <div class="max-w-7xl mx-auto px-6 text-center">
        <h3 class="text-3xl font-extrabold text-slate-800 mb-12">Kenapa Memilih FUTUREAPT Tryout?</h3>
...
<section class="bg-indigo-50 py-20">
    <div class="max-w-7xl mx-auto px-6">
        <h3 class="text-3xl font-extrabold text-center text-indigo-700 mb-12">Cara Kerja Tryout Online</h3>
    ...
    <div class="max-w-4xl mx-auto px-6">
        ...
        <div class="space-y-6">
            <div class="border-b pb-4">
                <h4 class="font-semibold text-lg text-indigo-700">Apakah FUTUREAPT gratis digunakan?</h4>
                <p class="text-slate-600 mt-2">Ya! Kamu bisa mendaftar dan mencoba tryout secara gratis. Untuk fitur lanjutan, akan tersedia paket berbayar (optional).</p>
            </div>
            <div class="border-b pb-4">
                <h4 class="font-semibold text-lg text-indigo-700">Apakah saya bisa mengulang tryout?</h4>
            ...
            <div class="border-b pb-4">
                ...
                <p class="text-slate-600 mt-2">Tentu! FUTUREAPT mendukung tampilan mobile, jadi kamu bisa latihan lewat smartphone dengan lancar.</p>
            </div>
        </div>
    </div>
</section>
...
<footer class="bg-white border-t pt-12 pb-6">
    <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-8 text-center md:text-left">
        ...
        <!-- CTA & Branding -->
        <div>
            <h4 class="text-xl font-extrabold text-indigo-700 mb-2">FUTUREAPT Tryout</h4>
        ...
        <div>
            ...
            <p class="text-sm text-slate-600">Email: <a href="mailto:support@futureapt.id" class="text-indigo-600 hover:underline">support@futureapt.id</a></p>
            <p class="text-sm text-slate-600 mt-1">WhatsApp: <a href="https://wa.me/6281234567890" target="_blank" class="text-indigo-600 hover:underline">+62 812-3456-7890</a></p>
        </div>
        ...
        <div>
            ...
            <div class="flex justify-center md:justify-start gap-4 mt-2">
                <a href="https://instagram.com/futureapt" target="_blank" class="text-indigo-600 hover:text-indigo-800 text-xl" title="Instagram">
                ...
                <a href="https://facebook.com/futureapt" target="_blank" class="text-indigo-600 hover:text-indigo-800 text-xl" title="Facebook">
                    <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M22.7 0H1.3C.6 0 0 .6 0 1.3v21.3C0 23.4.6 24 1.3 24h11.5v-9.3H9.7v-3.6h3.1V8.4c0-3.1 1.9-4.8 4.7-4.8 1.3 0 2.4.1 2.7.1v3.1h-1.9c-1.5 0-1.8.7-1.8 1.8v2.3h3.6l-.5 3.6h-3.1V24h6.1c.7 0 1.3-.6 1.3-1.3V1.3c.1-.7-.5-1.3-1.2-1.3z"/></svg>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="text-center text-xs text-slate-500 mt-10">
        &copy; 2025 FUTUREAPT Tryout. All rights reserved.
    </div>
</footer>
